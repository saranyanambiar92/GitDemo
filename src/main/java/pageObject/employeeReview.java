...
public class employeeReview {
    ...
    By E_action=By.xpath("//select[@id='sel1']");
 ...
 public employeeReview(WebDriver driver) 
	{ 
		this.driver=driver; 
 ...
 /*public void switch_to_frame()
 {
	...
	public void E_Resubmit() throws InterruptedException
	{
		Thread.sleep(2000);
		Select act=new Select(driver.findElement(E_action));
